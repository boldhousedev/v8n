...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('v8n'), require('underscore-bd')) :
    typeof define === 'function' && define.amd ? define(['exports', 'v8n', 'underscore-bd'], factory) :
    (global = global || self, factory(global.v8nx = {}, global.v8n, global._));
}(this, function (exports, v8n, _) { 'use strict';

    v8n = v8n && v8n.hasOwnProperty('default') ? v8n['default'] : v8n;
    _ = _ && _.hasOwnProperty('default') ? _['default'] : _;

    // v8n-99xp) is a set of validation
    ...
    var validateCNPJ = function (value) {
      ...
      const isSameDigitsCNPJ = cnpjFull => isIn(generateArray(10).map(generateStringSequence(14)))(cnpjFull);
      ...
      validTo(dateStartLimit, dateEndLimit) {
        return _.partial(function (dSL, dEL, v) {
          var validate = () => {
            ...
            if (dSL || dEL) {
              if (dSL) {
                dSL = dSL === true ? cD : new Date(dSL[0], (dSL[1] || 0) - 1, dSL[2] || 1, dSL[3] || 0, dSL[4] || 0, dSL[5] || 0);
